...
<script>
import { onBeforeMount, toRefs, reactive, computed } from "vue";
...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      ...
      filter: "",
      isUserAuthenticated: computed(() => authStore.IS_USER_AUTHENTICATED),
    });
    ...
    onBeforeMount(async () => {
      const ingredientReferentiels =
        await ingredientReferentielStore.getIngredientReferentiels();
